...
|Maximum Qty Allowed in Shopping Cart|Global|Determines the maximum number of a product that can be purchased in a single order by [customer group]({% link customers/customer-groups.md %}). By default, the maximum quantity is set to 10,000.|
